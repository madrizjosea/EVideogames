      ...
      {gamedata?.map(game => (
        <div className={style.game} key={game.id}>
          <div className={style.gamebody}>
            <img className={style.img} src={game.image} alt={'game'} />
            <div className={style.text}>
              <p>
                <NavLink className={style.navlink} to={`/Details/${game.id}`}>
                  {game.name}
                </NavLink>
              </p>
              <p>
            ...
            <p>
              Availability:{' '}
              {game.isAvailable === true ? 'Available' : 'Unavailable'}
            </p>
            <select
              className={style.select}
              onChange={e =>
                availabilityHandler(e, game.isAvailable, game.id, game.name)
              }
